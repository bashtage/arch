...
static const char __pyx_k_c_git_arch_arch_bootstrap__sampl[] = "c:\\git\\arch\\arch\\bootstrap\\_samplers.pyx";
...
static PyObject *__pyx_kp_s_c_git_arch_arch_bootstrap__sampl;
...
static PyObject *__pyx_n_s_stationary_bootstrap_sample;
...
/* "arch/bootstrap/_samplers.pyx":8
...
/* Python wrapper */
static PyObject *__pyx_pw_4arch_9bootstrap_9_samplers_1stationary_bootstrap_sample(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4arch_9bootstrap_9_samplers_stationary_bootstrap_sample[] = "\n    Parameters\n    -------\n    indices: 1-d array\n        Array containing draws from randint with the same size as the data in\n        the range of [0,nobs)\n    u : 1-d array\n        Array of standard uniforms\n    p : float\n        Probability that a new block is started in the stationary bootstrap.\n        The multiplicative reciprocal of the window length\n\n    Returns\n    -------\n    indices: 1-d array\n        Indices for an iteration of the stationary bootstrap\n    ";
static PyMethodDef __pyx_mdef_4arch_9bootstrap_9_samplers_1stationary_bootstrap_sample = {"stationary_bootstrap_sample", (PyCFunction)__pyx_pw_4arch_9bootstrap_9_samplers_1stationary_bootstrap_sample, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4arch_9bootstrap_9_samplers_stationary_bootstrap_sample};
static PyObject *__pyx_pw_4arch_9bootstrap_9_samplers_1stationary_bootstrap_sample(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_indices = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_u = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_p;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("stationary_bootstrap_sample (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_indices,&__pyx_n_s_u,&__pyx_n_s_p,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_u)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("stationary_bootstrap_sample", 1, 3, 3, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_p)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("stationary_bootstrap_sample", 1, 3, 3, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "stationary_bootstrap_sample") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_indices = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_int64_t(values[0]); if (unlikely(!__pyx_v_indices.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_u = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1]); if (unlikely(!__pyx_v_u.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_p = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_p == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("stationary_bootstrap_sample", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("arch.bootstrap._samplers.stationary_bootstrap_sample", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4arch_9bootstrap_9_samplers_stationary_bootstrap_sample(__pyx_self, __pyx_v_indices, __pyx_v_u, __pyx_v_p);
...
static PyObject *__pyx_pf_4arch_9bootstrap_9_samplers_stationary_bootstrap_sample(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_indices, __Pyx_memviewslice __pyx_v_u, double __pyx_v_p) {
  Py_ssize_t __pyx_v_num_items;
  ...
  __Pyx_RefNannySetupContext("stationary_bootstrap_sample", 0);

  /* "arch/bootstrap/_samplers.pyx":29
 *     """
 ...
 */
  __pyx_v_num_items = (__pyx_v_indices.shape[0]);

  /* "arch/bootstrap/_samplers.pyx":31
 *     num_items = indices.shape[0]
 * 
 *     for i in range(1, num_items):             # <<<<<<<<<<<<<<
 *         if u[i] > p:
 ...
 */
  __pyx_t_1 = __pyx_v_num_items;
  for (__pyx_t_2 = 1; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    __pyx_v_i = __pyx_t_2;

    /* "arch/bootstrap/_samplers.pyx":32
 * 
 *     for i in range(1, num_items):
 *         if u[i] > p:             # <<<<<<<<<<<<<<
 *             indices[i] = indices[i - 1] + 1
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    __pyx_t_4 = (((*((double *) ( /* dim=0 */ (__pyx_v_u.data + __pyx_t_3 * __pyx_v_u.strides[0]) ))) > __pyx_v_p) != 0);
    if (__pyx_t_4) {

      /* "arch/bootstrap/_samplers.pyx":33
 *     for i in range(1, num_items):
 *         if u[i] > p:
 *             indices[i] = indices[i - 1] + 1             # <<<<<<<<<<<<<<
 *             if indices[i] == num_items:
 ...
 */
      ...
      __pyx_t_6 = __pyx_v_i;
      *((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_6 * __pyx_v_indices.strides[0]) )) = ((*((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_5 * __pyx_v_indices.strides[0]) ))) + 1);

      /* "arch/bootstrap/_samplers.pyx":34
 *         if u[i] > p:
 *             indices[i] = indices[i - 1] + 1
 *             if indices[i] == num_items:             # <<<<<<<<<<<<<<
 *                 indices[i] = 0
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_4 = (((*((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_7 * __pyx_v_indices.strides[0]) ))) == __pyx_v_num_items) != 0);
      if (__pyx_t_4) {

        /* "arch/bootstrap/_samplers.pyx":35
 *             indices[i] = indices[i - 1] + 1
 *             if indices[i] == num_items:
 *                 indices[i] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_8 = __pyx_v_i;
        *((__pyx_t_5numpy_int64_t *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_8 * __pyx_v_indices.strides[0]) )) = 0;
 ...
 */
  ...
  /* "arch/bootstrap/_samplers.pyx":37
 *                 indices[i] = 0
 * 
 *     return indices             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_9 = __pyx_memoryview_fromslice(__pyx_v_indices, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_int64_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_int64_t, 0);; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 37, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "arch.bootstrap._samplers.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "arch.bootstrap._samplers.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "arch.bootstrap._samplers.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "arch.bootstrap._samplers._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_c_git_arch_arch_bootstrap__sampl, __pyx_k_c_git_arch_arch_bootstrap__sampl, sizeof(__pyx_k_c_git_arch_arch_bootstrap__sampl), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_stationary_bootstrap_sample, __pyx_k_stationary_bootstrap_sample, sizeof(__pyx_k_stationary_bootstrap_sample), 0, 0, 1, 1},
 ...
 *                                 double p):
 */
  __pyx_tuple__20 = PyTuple_Pack(5, __pyx_n_s_indices, __pyx_n_s_u, __pyx_n_s_p, __pyx_n_s_num_items, __pyx_n_s_i); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_c_git_arch_arch_bootstrap__sampl, __pyx_n_s_stationary_bootstrap_sample, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 8, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_samplers(void); /*proto*/
PyMODINIT_FUNC init_samplers(void)
#else
PyMODINIT_FUNC PyInit__samplers(void); /*proto*/
PyMODINIT_FUNC PyInit__samplers(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__samplers(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_samplers", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "arch.bootstrap._samplers")) {
      if (unlikely(PyDict_SetItemString(modules, "arch.bootstrap._samplers", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                                 double p):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4arch_9bootstrap_9_samplers_1stationary_bootstrap_sample, NULL, __pyx_n_s_arch_bootstrap__samplers); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_stationary_bootstrap_sample, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init arch.bootstrap._samplers", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init arch.bootstrap._samplers");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
